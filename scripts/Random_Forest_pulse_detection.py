...
def main():
    ...
    #combine_df.csv is the combined .csv of all FluxPulse final products in 34 sites. Access the individual site data and the combine_df.csv via https://www.keenangroup.info/index.html  
